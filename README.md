...
**Piloto oncológico construido y en vivo (julio 2026)** — 216 tests en verde; las tres caras funcionan (app del paciente con check-in por voz/texto, panel del profesional con disposición estructurada, dashboard del patrocinador con agregados k≥5); base de datos real aplicada y verificada (migraciones 0001–0013 + seed, RLS probada en vivo). Vertical: cáncer de mama (programas «Terapia oral» y «Tratamiento activo») + pediatría cuidador-proxy en cola. **Demo vendible:** `DEMO_MODE=true npm run dev` + `docs/DEMO-GUION.md`. Autoridad de producto: **[docs/MEMORIA-PROYECTO.md](docs/MEMORIA-PROYECTO.md)**; plan técnico: **[docs/PLAN-TECNICO-PILOTO.md](docs/PLAN-TECNICO-PILOTO.md)**; para continuar el trabajo: **[docs/PENDIENTE.md](docs/PENDIENTE.md)** (siguiente: WP-20 UX/enrolamiento).
